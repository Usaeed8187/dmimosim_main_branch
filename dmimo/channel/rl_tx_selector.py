...
class RLTxSelector:
    """Lightweight manager to run a single DEQN agent for selecting which Tx to use."""
    ...
    def __init__(
        ...
        self.num_tx_total = num_tx_total
        self.num_tx_to_swap = num_tx_to_swap

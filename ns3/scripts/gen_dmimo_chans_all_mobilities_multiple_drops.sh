...
ns3_channel_dir_end_high_mobility="_14_50_70_0_421_10_100.0_10.0_0.00_10_100.0_10.0_0.79_1000.0_1.0_1.0_2.0_1.5_0_0/"
...
for ((i=0; i<num_drops; i++)); do
    ...
    # python "$convert_ns3_channels_path" "$ns3_project_dir/dmimo_ch/$ns3_channel_dir_start$seed$ns3_channel_dir_end_high_mobility" "$channel_saving_dir/channels_high_mobility_$curr_drop_idx/"    

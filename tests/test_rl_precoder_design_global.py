...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("results/rl_precoder_design_global"))
    ...
    parser.add_argument("--best-of-n", type=int, default=8, help="Number of complete global joint candidate precoders sampled per slot; execute/train on the best by reward score.")
    parser.add_argument("--global-proxy-eta", type=float, default=10.0, help="Weight eta for PMI proxy sum-rate in the global joint product-sphere sampler.")
    parser.add_argument("--global-gibbs-sweeps", type=int, default=4, help="Number of Gibbs-style sweeps used to construct one global joint sample.")

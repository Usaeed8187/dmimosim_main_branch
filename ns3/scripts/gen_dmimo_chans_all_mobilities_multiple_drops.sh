...
curr_drop_idx=211
num_drops=500-210  # Number of iterations
num_subframes=200
initial_seed=3007+210  # Starting seed value
txsquad_ues=1
rxsquad_ues=6
...
ns3_channel_dir_end_high_mobility="_14_${num_subframes}_70_0_421_${txsquad_ues}_100.0_10.0_0.00_${rxsquad_ues}_100.0_10.0_0.79_1000.0_1.0_1.0_2.0_1.5_0_0/"
ns3_channel_dir_end_medium_mobility="_14_${num_subframes}_70_0_421_${txsquad_ues}_100.0_3.0_0.00_${rxsquad_ues}_100.0_3.0_0.79_1000.0_0.3_0.3_2.0_1.5_0_0/"
ns3_channel_dir_end_low_mobility="_14_${num_subframes}_70_0_421_${txsquad_ues}_100.0_3.0_0.00_${rxsquad_ues}_100.0_3.0_0.79_1000.0_0.3_0.3_2.0_1.5_0_0/"
dMIMO_project_dir="$HOME/dMIMO/dmimosim_main/"
convert_ns3_channels_path="$dMIMO_project_dir/ns3/convert_ns3_channels.py"

channel_saving_dir="$HOME/dMIMO/extra_ns3_channels_chanpred_RL/"
...
for ((i=0; i<num_drops; i++)); do
    ...
    python "$main_py_path" --seed $seed --scenario V2V-Urban --small_scale_fading --num_subframes $num_subframes --squad1_speed_km_h=10.0 --squad2_speed_km_h=10.0 --intra_sq1_rw_speed_km_h=1.0 --intra_sq2_rw_speed_km_h=1.0 --buildings_file 1narrow.txt --squad1_direction=0 --squad2_direction=0.785398 --format=both --nUEs_sq1=1 --nUEs_sq2=6
    raw_ns3_path="$ns3_project_dir/dmimo_ch/$ns3_channel_dir_start$seed$ns3_channel_dir_end_high_mobility"
    ...
    # python "$convert_ns3_channels_path" "$ns3_project_dir/dmimo_ch/$ns3_channel_dir_start$seed$ns3_channel_dir_end_medium_mobility" "$channel_saving_dir/channels_medium_mobility_$curr_drop_idx/"    
    ...
    # python "$convert_ns3_channels_path" "$ns3_project_dir/dmimo_ch/$ns3_channel_dir_start$seed$ns3_channel_dir_end_low_mobility" "$channel_saving_dir/channels_low_mobility_$curr_drop_idx/"    

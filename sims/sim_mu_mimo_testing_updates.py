...
channelmamba_batch_size = 512
channelmamba_dataloader_num_workers = 8
...
channelmamba_weight_decay = 1e-4
channelmamba_grad_clip = 1.0
channelmamba_d_model = 128
channelmamba_d_state = 256
channelmamba_d_conv  = 4
channelmamba_d_tf    = 64
channelmamba_num_transformer_layers = 1
channelmamba_num_td_layers = 2
channelmamba_num_bimamba_layers = 3
...
def run_simulation():
    ...
    cfg.channelmamba_enable_tf32 = channelmamba_enable_tf32
    cfg.channelmamba_epochs = channelmamba_epochs
    cfg.channelmamba_batch_size = channelmamba_batch_size
    cfg.channelmamba_dataloader_num_workers = channelmamba_dataloader_num_workers
    ...
    cfg.channelmamba_weight_decay = channelmamba_weight_decay
    cfg.channelmamba_grad_clip = channelmamba_grad_clip
    cfg.channelmamba_d_model = channelmamba_d_model
    cfg.channelmamba_d_state = channelmamba_d_state
    cfg.channelmamba_d_conv = channelmamba_d_conv
    cfg.channelmamba_d_tf = channelmamba_d_tf
    cfg.channelmamba_num_transformer_layers = channelmamba_num_transformer_layers
    cfg.channelmamba_num_td_layers = channelmamba_num_td_layers
    cfg.channelmamba_num_bimamba_layers = channelmamba_num_bimamba_layers
